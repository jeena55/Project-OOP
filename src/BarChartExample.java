...
public class BarChartExample extends JPanel {
    ...
    public ArrayList<Integer> getMonthlyData() {
        return monthlyData;
    }
        ...
        try {
            ...
            for (int i = 0; i <= 11; i++) {
                if (rs.next()) {
                    ...
                    monthlyData.add(Integer.parseInt(money));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static int getMaxValue(ArrayList<Integer> data) {
