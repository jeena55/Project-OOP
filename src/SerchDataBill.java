...
public class SerchDataBill {
    ...
    public void serch() {
        try {
            ...
            String query = "SELECT elecCost, monPay, ftDis, discount, total, vat, finalAmount, unitused, cname, address, district FROM databill WHERE monthCheck = ? AND yearCheck = ? AND numBill = ?";
