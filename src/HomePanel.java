...
public class HomePanel extends javax.swing.JPanel {
    ...
    public HomePanel() {
        ...
        StatementPanel currentBillAndTotal = new StatementPanel();
        jLabel7.setText(String.valueOf(currentBillAndTotal.getBillAddCurrent()));
        jLabel19.setText(String.valueOf(currentBillAndTotal.getTotal_bill()));

        ElectricListFrame total_elecList = new ElectricListFrame();
        jLabel11.setText(String.valueOf(total_elecList.getTotal()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/electrical-energy.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Poppins", 1, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 204, 204));
        jLabel2.setText("KANFAIFA");

        jLabel3.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 153, 153));
        jLabel3.setText("MAHANATER");

        jLabel4.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jLabel4.setText("Welcome to");

        jLabel8.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jLabel8.setText("0/0/0");
        ...
        jLabel5.setText("Current bill payment");

        jLabel7.setFont(new java.awt.Font("Poppins", 0, 48)); // NOI18N
        jLabel7.setText("0.00");

        jButton1.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        jButton1.setText("go to pay bill");
        ...
        jLabel9.setText("Power Used");

        jLabel6.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jLabel6.setText("for this month");

        jLabel11.setFont(new java.awt.Font("Poppins", 0, 48)); // NOI18N
        ...
        jButton3.setText("Electric List Manage");
        ...
        jLabel19.setFont(new java.awt.Font("Poppins", 0, 48)); // NOI18N
        jLabel19.setText("0.00");

        jLabel20.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        jLabel20.setText("baht");
